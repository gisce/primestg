...
DLMS_TEMPLATES = {
    # CONTRACTS
    'TAR_20TD': {
        'description': '3T_TDA - 2.0TD 3 periods and and special days. Activation on 2021/04/01',
        'origin': 'library',
        'category': 'contract',
        'params': [],
        'data':  [
            ...
            {'obis': "0.0.13.0.1.255", 'class': "20", 'element': "10", 'data': "raw{{090C07E50401FF000000000800FF}}"},
        ],
    },
    'TAR_30TD': {
        'description': '6T_TDA - 3.0TD with seasons and special days. Activation on 2021/04/01',
        'origin': 'library',
        'category': 'contract',
        'params': [],
        'data': [
